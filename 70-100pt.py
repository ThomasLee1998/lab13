...
circle2 = drawpad.create_oval(50,50,200,200, fill="purple")
circle3 = drawpad.create_oval(400,400,500,500, fill="black")
...
class MyApp:
 ...
 #button 2
	    ...
	    self.button3.configure(text="left", background= "blue")
